...
<nav class="navbar navbar-light" style="margin-top: -25px; width: 1600px; background-color: #5a1dc736">
...
<div class="container">
    <div class="row">
        <div class="col-6" style="margin-left:25%">
            <form id="formDoctor" style="color: #6f42c1; font-style: oblique" name="formDoctor" method="post"
                  action="doctor.jsp">
                <!-- DOCTOR ID -->
                ID:
                <input type="number" id="doctor_id2" name="doctor_id2" class="form-control form-control-sm"
                       onclick="saveBtnValidation()">
                <!-- FIRSTNAME -->
                <br>
                First Name:
                ...
                <br>
                Joining Date:
                <input type="text" id="joinedDate2" name="joinedDate2" class="form-control form-control-sm"
                       onclick="saveBtnValidation()">
